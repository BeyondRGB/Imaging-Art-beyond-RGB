<script lang="ts">
	...
	const autoSort = function () {
		processState.update(state => ({
			...state,
			imageFilePaths: autoSortImages(getAllImages(), imageStack),
		}));
	...
	{#key rerenderToggle}
		<panel>
			...
			<div>
				...
				<div class="btnGroup" style="margin: 50px 65px 0 0;">
				...
				<div id="imageStack">
					...
					<div class="inputGroup">
						<div class="cell">
							<Dropbox
								type="image"
								bind:items={imageStack.imageA[0]}
								singleItem={true}
						...
						<div class="cell">
							<Dropbox
								type="image"
								bind:items={imageStack.imageB[0]}
								singleItem={true}
								showError={!!validationError}
							/>
						</div>
