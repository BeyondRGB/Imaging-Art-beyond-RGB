	...
	<left>
		...
		<div>
			{#if sortedImageCount > 0}
				...
				<ImageRoleGrid bind:imageStack roleType="object" {artImageCount} showHeaders={true} />
				<h3 class="text">Object</h3>

				<h3 class="text">Target</h3>
				<ImageRoleGrid bind:imageStack roleType="target" showHeaders={false} />

				<h3 class="text">FlatField</h3>
				<ImageRoleGrid bind:imageStack roleType="flatfield" showHeaders={false} />

				<h3 class="text">DarkField</h3>
				<ImageRoleGrid bind:imageStack roleType="darkfield" showHeaders={false} />
			{/if}
		</div>
	</left>
	<right>
