...
<main>
	<div class="settings">
		...
		<div class="content">
			<div class="info-section">
				<div class="template-info">
					<p>
						To use custom reference data you must use the template. All data and coordinates must be
						inputed correctly!
					</p>
					<a class="downloadLink" href={RefDataTemplate} download="RefDataTemplate.csv">
						<Button
			...
			<div class="input-section">
				<FileSelector bind:filePaths label={"Select Reference Data"} type="Single" filter="csv" />
		...
		<div class="footer">
			<Button variant="success" onClick={confirm} disabled={!filePaths || filePaths.length === 0}
				>Confirm</Button
			>
		</div>
	</div>
