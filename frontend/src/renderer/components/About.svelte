...
<main>
	...
	<ScrollContainer maxHeight="65vh" className="body">
		<div class="content-wrapper" in:fade={{ duration: 400, delay: 200 }}>
			<!-- Overview Section -->
			<section class="info-section">
				...
				<p class="section-text">
					Beyond RGB is an open-source software application for processing spectral image sets. It
					takes as input two RAW (or unprocessed linear TIFF) RGB image sets
					(object/flatfield/darkfield) captured under two different lighting or filtering
					conditions, and outputs:
				</p>
				<div class="feature-list">
					<div class="feature-item">
						<CheckCircleIcon size="1x" class="feature-icon" />
						<span>A color managed RGB image</span>
					</div>
					<div class="feature-item">
						<CheckCircleIcon size="1x" class="feature-icon" />
						<span
							>A spectral reflectance transform that enables the interactive estimation of
							reflectance curves from user-selected regions of interest in the image</span
						>
					</div>
					<div class="feature-item">
						<CheckCircleIcon size="1x" class="feature-icon" />
						<span
							>Two sets of ancillary data and plots detailing the accuracy of the color and spectral
							calibrations, respectively</span
						>
					</div>
				</div>
			</section>
			...
			<section class="info-section">
				...
				<p class="section-text">
					Beyond RGB was designed with considerations for form, function, and user friendliness, and
					is intended for use by cultural heritage imaging professionals. It is cross-platform
					compatible and operable via an interactive graphical user interface, and will continue to
					be a living, updatable open-source project.
				</p>
				<div class="contact-box">
					<p class="contact-text">
						It is freely available for download from the <a
							href="https://beyondrgb.github.io/"
							target="_blank">BeyondRGB website</a
						>.
					</p>
					<p class="contact-email">
						Please direct comments and questions to <a href="mailto:susan.farnand@rit.edu"
							>susan.farnand@rit.edu</a
						>
					</p>
				</div>
			</section>
			...
			<section class="info-section team-section">
				...
				<p class="section-text">
					Beyond RGB was developed by talented teams of developers across five years who dedicated
					their time and expertise to creating this powerful tool for the cultural heritage imaging
					community.
				</p>
...
<style lang="postcss">
	...
	.info-section {
		...
		@apply rounded-xl p-6 border border-gray-700/20;
	}
	...
	.section-header {
		color: var(--color-text-primary);
		@apply flex items-center gap-3 mb-4 pb-3 border-b border-gray-700/30;
	}
	...
	.feature-item {
		...
		@apply flex items-start gap-3 p-4 rounded-lg border border-gray-700/20 transition-all duration-200;
	}

	.feature-item:hover {
		background-color: var(--color-interactive-hover);
		@apply border-blue-500/30 transform translate-x-1;
	}
	...
	.contact-box {
		background-color: var(--color-surface-sunken);
		@apply p-5 rounded-lg border-l-4 border-blue-500/50 mt-4;
	}
	...
	.team-member {
		background-color: var(--color-surface-sunken);
		color: var(--color-text-primary);
		@apply px-4 py-3 rounded-lg text-center font-medium border border-gray-700/20
           transition-all duration-200;
	}

	.team-member:hover {
		background-color: var(--color-interactive-hover);
		@apply border-blue-500/40 transform scale-105;
	}

	.thank-you {
		color: var(--color-text-secondary);
		@apply text-sm text-center italic mt-4 pt-4 border-t border-gray-700/20;
	}

	.easter-egg {
		@apply block mt-1 text-xs opacity-70;
	}
