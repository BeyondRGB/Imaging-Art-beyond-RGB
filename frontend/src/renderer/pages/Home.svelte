<script lang="ts">
	...
	import { CrosshairIcon, ApertureIcon, InfoIcon, CopyIcon } from "svelte-feather-icons";
...
<main>
	...
	<div id="homeContent">
		<div id="welcome">
			<h1 in:fade={{ duration: 1000, delay: 1000 }} class="dark:text-gray-400">Welcome to</h1>
			<img in:fade={{ duration: 1500, delay: 1750 }} src={TextLogo} alt="app-logo" />
		</div>
		<div class="btnCol">
