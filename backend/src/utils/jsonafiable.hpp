...
/**
 * @brief Class to be inherited by classes that can be serialized/deserialized into json
 * It is the responsiblity of the inheritor to define jsonafy and de_jsonafy
 * 
 */
class Jsonafiable{
    ...
    public:
         ...
         * @return jsoncons::json json object representing the contents found in file
        ...
        /**
         * @brief Generic function for creating a json object from an unordered map of type<std::string, T>
         * This will create a json list of json objects containing values of type T
         * 
