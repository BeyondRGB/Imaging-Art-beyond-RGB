...
CIccProfile *CreateIccProfile::createSpecProfile(ProfileColorSpace base_space,
    ...
    if (ignore_base_channels) {
        ...
        case cs_Adobe_RGB_1998:
            ...
            {
                icFloatNumber params[4] = {563.0f / 256.0f, 1.00000f, 0.00000f,
                                           0.0000f};
            ...
            pSegment = new CIccFormulaCurveSegment(icMinFloat32Number,
                                                   icMaxFloat32Number);
            {
                icFloatNumber params[4] = {1.0000f, 1.00000f, 0.00000f,
                                           0.0000f};
                pSegment->SetFunction(0, 4, params);
            }
            pCurve->Insert(pSegment);
        ...
        case cs_sRGB:
            ...
            {
                icFloatNumber params[4] = {1.0f, 0.077399380804954, 0.00000f,
                                           0.0000f};
                pSegment->SetFunction(0, 4, params);
            }
            pCurve->Insert(pSegment);
            ...
            {
                icFloatNumber params[4] = {2.4f, 0.947867298578199,
    ...
    if (inv_matrix) {
        ...
        case cs_Adobe_RGB_1998:
            ...
            pSegment = new CIccFormulaCurveSegment(0.0f, icMaxFloat32Number);
            {
                icFloatNumber params[4] = {256.0 / 563.0f, 1.00000f, 0.00000f,
                                           0.0000f};
                pSegment->SetFunction(0, 4, params);
            }
            pCurve->Insert(pSegment);
        ...
        case cs_ProPhoto:
            ...
            {
                icFloatNumber params[4] = {0.555557250977f, 1.00000f, 0.00000f,
                                           0.0000f};
                pSegment->SetFunction(0, 4, params);
            }
            pCurve->Insert(pSegment);
