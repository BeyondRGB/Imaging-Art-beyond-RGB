...
ColorPatch::ColorPatch(short row, short col, Illuminants *illum,
                       StandardObserver *so, WhitePoints *white_pts) {
    this->row = row;
    this->col = col;
...
double ColorPatch::get_x() { return this->x; }

double ColorPatch::get_y() { return this->y; }

double ColorPatch::get_z() { return this->z; }

double ColorPatch::get_L() { return this->l; }

double ColorPatch::get_a() { return this->a; }

double ColorPatch::get_b() { return this->b; }
