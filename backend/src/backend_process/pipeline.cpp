...
void Pipeline::init_general_info(btrgb::ArtObject* art_obj){
    ...
    // Target Coords
    results_obj->store_double(GI_TARGET_TOP, target_json.get_number("top")*target_json.get_number("Yresoltuion"));
    results_obj->store_double(GI_TARGET_BOTTOM, target_json.get_number("bottom") * target_json.get_number("Yresoltuion"));
    results_obj->store_double(GI_TARGET_LEFT, target_json.get_number("left") * target_json.get_number("Xresoltuion"));
    results_obj->store_double(GI_TARGET_RIGHT, target_json.get_number("right") * target_json.get_number("Xresoltuion"));
    // Observer
