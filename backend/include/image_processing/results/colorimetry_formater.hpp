...
class ColorimetryFormater : public ResultsFormater {
  private:
    std::string colum_headers[20] = {
        "Patch ID",   "DE00",       "L_ref",      "a_ref",      "b_ref",
        "L_camera",   "a_camera",   "b_camera",   "X_ref",      "Y_ref",
        "Z_ref",      "X_camera",   "Y_camera",   "Z_camera",   "R_1_camera",
        "G_1_camera", "B_1_camera", "R_2_camera", "G_2_camera", "B_2_camera"};
