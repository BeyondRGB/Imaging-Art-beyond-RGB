...
public:
	...
	*/
	void send_error(std::string msg, std::string sender, cpptrace::stacktrace trace, bool critical=true);
	/**
	...
	*/
	...
	void send_spectrum_measured(float* estimated_data, float* referenced_data, int size);
