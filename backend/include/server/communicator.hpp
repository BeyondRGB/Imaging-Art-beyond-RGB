...
A class that inherits from this class can send messages to the front end using
the communication obj once it has been set. NOTE: before a message can be sent
successfully set_coms_obj must be called
*/
class Communicator {
