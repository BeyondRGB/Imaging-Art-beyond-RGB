...
class BackendProcess : public Communicator {
  ...
  public:
    ...
    */
     ...
     * @param data: a json object containing any and all process data provided
     * with request data should be the json obj found in the RequestData feild
     * in original request string
     */
    void set_process_data(Json data) {
        process_data_m = std::shared_ptr<Json>(new Json(data));
    }
