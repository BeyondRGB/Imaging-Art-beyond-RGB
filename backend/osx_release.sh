...
cmake -B ./build/Release -S . -D CMAKE_OSX_DEPLOYMENT_TARGET=$macOS_vers_num -D CMAKE_BUILD_TYPE=Release -D VCPKG_TARGET_TRIPLET=x64-osx
...
mkdir ../frontend/lib/
cp -v ./build/Release/beyond-rgb-backend ../frontend/lib/
